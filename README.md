...
* **Window Management:** Fully draggable application windows. Click a window and it comes to the front. Top bar stays up top so it doesnt sit on the welcome button anymore.
...
2. Ensure your file directory contains the required asset mappings, Ex: `/pics/1.png`, `/pics/2.png`, `/pics/3.png` and `images/sofa.jpg`
